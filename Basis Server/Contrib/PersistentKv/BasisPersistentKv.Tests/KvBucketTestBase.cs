...
namespace BasisPersistentKv.Tests
{
    ...
    /// </summary>
    public abstract class KvBucketTestBase
    {
        protected KvBucketTestBase(ITestOutputHelper output)
        {
            Output = output;
        }
        ...
        protected async Task<IKVBucket> CreateBucketAsync()
        {
            ...
            var addResult = await BasisPersistientKVDatabase.AddBucketAsync(userId);
