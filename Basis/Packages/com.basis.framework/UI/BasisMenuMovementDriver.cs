...
namespace Basis.Scripts.UI.UI_Panels
{
    public class BasisMenuMovementDriver : MonoBehaviour
    {
        ...
        private void OnDisable()
        {
            ...
            BasisLocalHeight.OnChangedNextFrame -= UpdateDelayedSetUI;
        ...
        public void SetUIPositionAndRotation()
        {
            switch (menuType)
            {
                case MenuType.Floating:
                    ...
                    newPos = LocalPlayer.transform.position + (projectedPos * (0.5f * LocalPlayer.Height.PlayerScaleVsFallback));
                ...
                case MenuType.Hand:
                    ...
                    if (!BasisDeviceManagement.IsUserInDesktop())
                    {
                        ...
                        transform.SetPositionAndRotation(position + (menuPosOffset * LocalPlayer.Height.PlayerScaleVsFallback), rotation * Quaternion.Euler(menuRotOffset));
                    }
                    else
                    {
