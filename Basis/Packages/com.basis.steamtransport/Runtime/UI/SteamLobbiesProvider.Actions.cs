...
namespace Basis.Scripts.Networking.Steam
{
    public partial class SteamLobbiesProvider
    {
        ...
        {
            useRelayToggle.SetValueWithoutNotify(BasisSteamNetworkStack.GetConfig().UseSteamRelay);
        ...
        private async Task OnCreateLobbyButton()
        {
            ...
            try
            {
                ...
                await BasisSteamNetworkIntegration.ResetNetworkStateAsync(keepSteamLobby: true);
                BasisSteamNetworkIntegration.PrepareSteamConnection(
                    lobbyState,
                    true,
                    validation.WorldUrl,
                    validation.WorldPassword,
        ...
        private async Task OnJoinLobbyButton()
        {
            ...
            try
            {
                ...
                await BasisSteamNetworkIntegration.ResetNetworkStateAsync(keepSteamLobby: true);
                BasisSteamNetworkIntegration.PrepareSteamConnection(joinedLobby, false);
        ...
        private void ApplyUiState()
        {
            ...
            bool isConnected = BasisNetworkConnection.LocalPlayerIsConnected;
