...
public class BasisFallBackBoneDataEditor : Editor
{
    ...
    private void ComputeEyeBone(BasisFallBackBoneData fallBackBoneData)
    {
        ...
        EyeBone.PositionPercentage = CalculatePercentage(Vector3.zero, new Vector3(0, BasisLocalHeight.FallbackEyeHeightMeters, 0), EyeBone.Position);
    ...
    public Bounds GetBounds(Transform Animatorparent)
    {
        ...
        {
            return new Bounds(Vector3.zero, new Vector3(0.3f, BasisLocalHeight.FallbackEyeHeightMeters, 0.3f));
        }
