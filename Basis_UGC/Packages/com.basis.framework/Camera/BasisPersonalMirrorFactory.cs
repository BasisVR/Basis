...
{
    public static string PersonalMirrorPrefabPath = "Packages/com.basis.sdk/Prefabs/UI/Personal Mirror Prefab/PersonalMirror.prefab";
    public static async Task<BasisPersonalMirror> CreateMirror(InstantiationParameters InstantiationParameters)
    {
        ...
        var data = await AddressableResourceProcess.LoadAsGameObjectsAsync(PersonalMirrorPrefabPath, InstantiationParameters, Required, BundledContentHolder.Selector.System);
